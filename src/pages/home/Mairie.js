    ...
    <>
      <div className="bloc-1">
        <div className="bloc-1_text">
          ...
          <p>
            ...
            là. Les informations sur celui-ci se trouvent dans la section un peu plus basse.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>Un autre devant la salle des fêtes de 16 places (à 50 m environ),</li>
            <li>Et le dernier se situe derrière la salle des fêtes sur le terrain communal.</li>
          </ul>
          <p>
            La voirie de la commune venant d'être refait en 2022, celle-ci reste très attentive au
            stationnement sur les trottoirs. Et accessoirement nous aimerions faire bonne
            impression.
          </p>
        </div>
      ...
      <div className="bloc-2">
        ...
        <div className="bloc-2_text">
          <h4>Les accès</h4>
          <p>
            Notre commune se trouve à 4 km de Gournay en Bray dans la Seine Maritime(76), sur l'axe
            principale Beauvais-Rouen via la RN31.
          </p>
          <p>
            Nous sommes à 45 min de Beauvais ou débouche l'autoroute A16 et a 50min de Rouen ou
            débouche les autoroutes A13 et A28.
          </p>
